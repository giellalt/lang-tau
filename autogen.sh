...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_tau to login script."
...
# the current dir:
if   test x${GTLANG_tau} = x ; then
	echo "WARNING: The variable \${GTLANG_tau} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_tau} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_tau} has the value:"
	echo "  ${GTLANG_tau}"
